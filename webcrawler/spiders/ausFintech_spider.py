...
class e27_spider(scrapy.Spider):
	...
	# base_url = ['https://e27.co/top100-fight-club-first-20-startups-showcasing-echelon-asia-summit-175474/']

	# allowed_domains = ['http://www.e27.co']
	# base_url = generate_startup_list()
	# base_url = ['https://e27.co/startup/freighkart','https://e27.co/startup/komachine','https://e27.co/startup/smart-trade-inc']
